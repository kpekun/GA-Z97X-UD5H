 ...
 *
 * Disassembly of C:/Users/Korhan/Desktop/DSDT.aml, Sun Apr 12 12:15:56 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001186B (71787)
 *     Revision         0x02
 *     Checksum         0x5A
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xD8FAAA98, 0x0350)
            ...
            Device (RP05)
            {
                ...
                Device (MVL1)
                {
                    ...
                    Device (IDE0)
                    {
                        ...
                        {
                            Local0 = DerefOf (PIOT [PIO0])
                            Local2 = DerefOf (PIOT [PIO1])
                            Local4 = 0x1A
                            If ((FLGP && One))
                            {
                                If (!MULT)
                                ...
                                Local1 = DerefOf (UDMA [DMA0])
                                Local4 |= One
                            }
                            Else
                            {
                                Local1 = DerefOf (MDMA [MDA0])
                            }
                            ...
                            If ((FLGP && 0x04))
                            {
                                ...
                                Local3 = DerefOf (UDMA [DMA1])
                                Local4 |= 0x04
                            }
                            Else
                            {
                                Local3 = DerefOf (MDMA [MDA1])
                            }
                            ...
                            GTM3 = Local3
                            GTM4 = Local4
                            Return (IDEB) /* \_SB_.PCI0.RP05.MVL1.IDEB */
                        }

                        Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                        {
                            IDEB = Arg0
                            Local0 = GTM0 /* \_SB_.PCI0.RP05.MVL1.GTM0 */
                            Local1 = GTM1 /* \_SB_.PCI0.RP05.MVL1.GTM1 */
                            Local2 = GTM2 /* \_SB_.PCI0.RP05.MVL1.GTM2 */
                            Local3 = GTM3 /* \_SB_.PCI0.RP05.MVL1.GTM3 */
                            Local4 = GTM4 /* \_SB_.PCI0.RP05.MVL1.GTM4 */
                            FLGP = Local4
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                PIOM = PIO0 /* \_SB_.PCI0.RP05.MVL1.PIO0 */
                                PIOM |= 0x08
                                If ((FLGP && One))
                                {
                                    DMAM = DMA0 /* \_SB_.PCI0.RP05.MVL1.DMA0 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA0 /* \_SB_.PCI0.RP05.MVL1.MDA0 */
                                    DMAM |= 0x20
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO1 /* \_SB_.PCI0.RP05.MVL1.PIO1 */
                                PIOM |= 0x08
                                If ((FLGP && 0x04))
                                {
                                    DMAM = DMA1 /* \_SB_.PCI0.RP05.MVL1.DMA1 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA1 /* \_SB_.PCI0.RP05.MVL1.MDA1 */
                                    DMAM |= 0x20
                                }
                    ...
                    Device (IDE1)
                    {
                        ...
                        Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                        {
                            Local0 = DerefOf (PIOT [PIO2])
                            Local2 = DerefOf (PIOT [PIO3])
                            Local4 = 0x1A
                            If ((FLGS && One))
                            {
                                If (!MULT)
                                ...
                                Local1 = DerefOf (UDMA [DMA2])
                                Local4 |= One
                            }
                            Else
                            {
                                Local1 = DerefOf (MDMA [MDA2])
                            }
                            ...
                            If ((FLGS && 0x04))
                            {
                                ...
                                Local3 = DerefOf (UDMA [DMA3])
                                Local4 |= 0x04
                            }
                            Else
                            {
                                Local3 = DerefOf (MDMA [MDA3])
                            }
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO2 /* \_SB_.PCI0.RP05.MVL1.PIO2 */
                                PIOM |= 0x08
                                If ((FLGS && One))
                                {
                                    DMAM = DMA2 /* \_SB_.PCI0.RP05.MVL1.DMA2 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA2 /* \_SB_.PCI0.RP05.MVL1.MDA2 */
                                    DMAM |= 0x20
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO3 /* \_SB_.PCI0.RP05.MVL1.PIO3 */
                                PIOM |= 0x08
                                If ((FLGS && 0x04))
                                {
                                    DMAM = DMA3 /* \_SB_.PCI0.RP05.MVL1.DMA3 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA3 /* \_SB_.PCI0.RP05.MVL1.MDA3 */
                                    DMAM |= 0x20
                                }
                ...
                Device (MVL2)
                {
                    ...
                    Device (IDE0)
                    {
                        ...
                        Method (_GTM, 0, NotSerialized)  // _GTM: Get Timing Mode
                        {
                            ...
                            GTM3 = Local3
                            GTM4 = Local4
                            Return (IDEB) /* \_SB_.PCI0.RP05.MVL2.IDEB */
                        }

                        Method (_STM, 3, NotSerialized)  // _STM: Set Timing Mode
                        {
                            IDEB = Arg0
                            Local0 = GTM0 /* \_SB_.PCI0.RP05.MVL2.GTM0 */
                            Local1 = GTM1 /* \_SB_.PCI0.RP05.MVL2.GTM1 */
                            Local2 = GTM2 /* \_SB_.PCI0.RP05.MVL2.GTM2 */
                            Local3 = GTM3 /* \_SB_.PCI0.RP05.MVL2.GTM3 */
                            Local4 = GTM4 /* \_SB_.PCI0.RP05.MVL2.GTM4 */
                            FLGP = Local4
                            If (((Local0 != 0xFFFFFFFF) && (Local0 != Zero)))
                            {
                                PIO0 = Match (PIOT, MEQ, Local0, MTR, Zero, Zero)
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO0 /* \_SB_.PCI0.RP05.MVL2.PIO0 */
                                PIOM |= 0x08
                                If ((FLGP && One))
                                {
                                    DMAM = DMA0 /* \_SB_.PCI0.RP05.MVL2.DMA0 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA0 /* \_SB_.PCI0.RP05.MVL2.MDA0 */
                                    DMAM |= 0x20
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO1 /* \_SB_.PCI0.RP05.MVL2.PIO1 */
                                PIOM |= 0x08
                                If ((FLGP && 0x04))
                                {
                                    DMAM = DMA1 /* \_SB_.PCI0.RP05.MVL2.DMA1 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA1 /* \_SB_.PCI0.RP05.MVL2.MDA1 */
                                    DMAM |= 0x20
                                }
                    ...
                    Device (IDE1)
                    {
                        ...
                        Device (DRV0)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO2 /* \_SB_.PCI0.RP05.MVL2.PIO2 */
                                PIOM |= 0x08
                                If ((FLGS && One))
                                {
                                    DMAM = DMA2 /* \_SB_.PCI0.RP05.MVL2.DMA2 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA2 /* \_SB_.PCI0.RP05.MVL2.MDA2 */
                                    DMAM |= 0x20
                                }
                        ...
                        Device (DRV1)
                        {
                            ...
                            Method (_GTF, 0, NotSerialized)  // _GTF: Get Task File
                            {
                                ...
                                CreateByteField (Local0, One, PIOM)
                                CreateByteField (Local1, One, DMAM)
                                PIOM = PIO3 /* \_SB_.PCI0.RP05.MVL2.PIO3 */
                                PIOM |= 0x08
                                If ((FLGS && 0x04))
                                {
                                    DMAM = DMA3 /* \_SB_.PCI0.RP05.MVL2.DMA3 */
                                    DMAM |= 0x40
                                }
                                Else
                                {
                                    DMAM = MDA3 /* \_SB_.PCI0.RP05.MVL2.MDA3 */
                                    DMAM |= 0x20
                                }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xD8E03E98, 0x10)
...
, 
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            "937308352451Genuine NVIDIA Certified SLI Ready Motherboard for GIGABYTE Z97X-UD5H  edc8-Copyright 2014 NVIDIA Corporation All Rights Reserved-950249559801(R)"
        })
        Device (WMI1)
        {
